...
controlParameterList = {
    ...
    'numberOfEvents'        :   10000, # how many sequential calculations
...
hydroControl = {
    ...
    'saveResultGlobs'       :   ['surface.dat', 'dec*.dat', 'ecc*.dat', 'VISH2p1_tec.dat'], # files match these globs will be saved
...
EbeCollectorParameters = {
    'subfolderPattern'      :   '"results-avg-(\d*)"',
    'databaseFilename'      :   'collected_V2.db',
}
...
def sequentialEventDriverShell():
    ...
    try:
        ...
        resultDir = '/home/plumberg.1/TEST_RESULTS'
        ...
        for aInitialConditionFile in ['../../ICs/COPY_results-avg/sd_avg_1000evs_block.dat']:
            ...
            eventResultDir = '/home/plumberg.1/TEST_RESULTS/NEW_TDEP_V2_results-avg-1'
		...
		#stdout.write("Skipping iSWithResonancesWithHydroResultFiles for now...\n")
		stdout.flush()
...
if __name__ == "__main__":
	...
	generateSuperMCInitialConditions(controlParameterList['numberOfEvents'])
