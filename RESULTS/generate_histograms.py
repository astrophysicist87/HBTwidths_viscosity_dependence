...
def plot_EbE_R2ij_v2(ebs, radiiForEvents, radiiForEventsNODF, direction, ymin, ymax, chosenFigSize):
	...
	ax2.plot(delete(binsKT00n,-1) + 0.5*dKT, nKT00n, '-o', label='$K_T = 0.0$ GeV')
	ax2.plot(delete(binsKT02n,-1) + 0.5*dKT, nKT02n, '-o', label='$K_T = 0.2$ GeV')
	ax2.plot(delete(binsKT04n,-1) + 0.5*dKT, nKT04n, '-o', label='$K_T = 0.4$ GeV')
	ax2.plot(delete(binsKT06n,-1) + 0.5*dKT, nKT06n, '-o', label='$K_T = 0.6$ GeV')
	ax2.plot(delete(binsKT08n,-1) + 0.5*dKT, nKT08n, '-o', label='$K_T = 0.8$ GeV')
	ax2.plot(delete(binsKT10n,-1) + 0.5*dKT, nKT10n, '-o', label='$K_T = 1.0$ GeV')
	...
	labels = [r'$K_T = 0.0$ GeV', r'$K_T = 0.2$ GeV', r'$K_T = 0.4$ GeV', r'$K_T = 0.6$ GeV', r'$K_T = 0.8$ GeV', r'$K_T = 1.0$ GeV']
