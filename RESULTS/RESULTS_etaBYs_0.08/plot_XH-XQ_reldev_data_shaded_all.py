...
def generate_all_plots():
	...
	LHLQdata=loadtxt('NEW_TDEP_V1/NEW_TDEP_V1_results-avg-1' + df_stem + '/HBTradii_cfs_ev1.dat_cfs_0')[:,cols1]
	LHHQdata=loadtxt('NEW_TDEP_V2/NEW_TDEP_V2_results-avg-1' + df_stem + '/HBTradii_cfs_ev1.dat_cfs_0')[:,cols1]
	HHLQdata=loadtxt('NEW_TDEP_V3/NEW_TDEP_V3_results-avg-1' + df_stem + '/HBTradii_cfs_ev1.dat_cfs_0')[:,cols1]
	HHHQdata=loadtxt('NEW_TDEP_V4/NEW_TDEP_V4_results-avg-1' + df_stem + '/HBTradii_cfs_ev1.dat_cfs_0')[:,cols1]
